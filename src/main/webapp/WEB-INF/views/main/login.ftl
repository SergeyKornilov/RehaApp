            ...
            <div class="col">
                <div class="login-form">
                    ...
                    <form  action="/login" method="post">
                        <div><input class="form-control input-username-password" type="text" name="username" placeholder="Username" autocomplete="off"/> </div>
                        <div><input class="form-control input-username-password" type="password" name="password" placeholder="Password" autocomplete="off"/> </div>
